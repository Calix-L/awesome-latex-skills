...
### Skills
- **latex-rescue**: Diagnose and fix LaTeX compilation errors. 85+ error patterns, 10 categories, engine auto-detection, quick-entry mode.
...
- **latex-fmt**: Reformat papers for 9 major CS venues (NeurIPS, ICML, CVPR, ACL, AAAI, ICLR, IEEE, Nature, Science).
...
- 12 reference files with curated domain knowledge